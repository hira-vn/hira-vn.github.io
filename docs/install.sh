...
# Configuration
# ---------------------------------------------------------------------------
REPO_URL="https://github.com/hira-vn/cli.git"
REPO_WEB_URL="https://github.com/hira-vn/cli"  # without .git, for GitHub web APIs
INSTALL_DIR="${HIRA_INSTALL_DIR:-$HOME/.hira/server}"
BREW_PACKAGE="hira-vn/tap/cli"
...
install_cli_binary() {
  ...
  local url="https://github.com/hira-vn/cli/releases/download/${latest}/hira_${OS}_${ARCH}.tar.gz"
  local tmp_dir
  tmp_dir=$(mktemp -d)
...
run_default() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/hira-vn/cli/main/scripts/install.sh | bash -s -- --with-server\n"
  printf "\n"
}
...
run_with_server() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/hira-vn/cli/main/scripts/install.sh | bash -s -- --stop\n"
  printf "\n"
}
